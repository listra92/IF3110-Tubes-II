// Date Picker Javascript for dropdown at Expired Date (Credit Card)
// Dongkol Ampas Bro
...
/** Membuat sebuah datepicker baru */
new datepickr('expired_date', { 'dateFormat': 'Y-m-d' });